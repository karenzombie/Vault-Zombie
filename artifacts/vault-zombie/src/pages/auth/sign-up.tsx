...
export default function SignUpPage() {
  ...
  if (authLoaded && isSignedIn) return <main className="min-h-[100dvh] grid place-items-center bg-background text-text-2">Redirecting…</main>;
